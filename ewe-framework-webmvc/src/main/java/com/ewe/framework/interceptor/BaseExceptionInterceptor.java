package com.ewe.framework.interceptor;
 ...
 * 2015-6-2
 */
public class BaseExceptionInterceptor implements HandlerExceptionResolver {
	...
	private ModelAndView resolveExceptionJson(HttpServletRequest request,
		...
		if(log.isInfoEnabled()){
			log.error("error,msg:"+baseException.getMsg());
